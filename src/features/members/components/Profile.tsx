...
import { useCurrentMember } from "../api/user-current-member";
...
const Profile = ({ memberId, onClose }: ProfileProps) => {
    ...
    const [RemoveDialog, confirmRemove] = useConfirm("Remove member", "Are you sure you want remove member from workspace");
    const [UpdateDialog, confirmUpdate] = useConfirm("Update Role", "Are you sure you want change the member's role?");
