...
export const ThreadBar = ({ count, timestamp, image, onClick, name = "Member" }: ThreadBarProps) => {
    ...
    return (
        ...
        >
            <div className="flex items-center gap-2 overflow-hidden">
                ...
                <span className="text-xs text-muted-foreground group-hover/thread-bar:hidden black">
